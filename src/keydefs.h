...
LayoutKey _MLPI_       = {ML_PI,           &Macro};       LayoutKey* MLPI    = &_MLPI_;
LayoutKey _MLINF_      = {ML_INF,          &Macro};       LayoutKey* MLINF   = &_MLINF_;
LayoutKey _MLSQRT_     = {ML_SQRT,         &Macro};       LayoutKey* MLSQRT  = &_MLSQRT_;
LayoutKey _MLGREQ_     = {ML_GREQ,         &Macro};       LayoutKey* MLGREQ  = &_MLGREQ_;
LayoutKey _MLLSEQ_     = {ML_LSEQ,         &Macro};       LayoutKey* MLLSEQ  = &_MLLSEQ_;
...
LayoutKey _RKK_        = {R_KAGI_KAKKO,     &Chara1};     LayoutKey* RKK     = &_RKK_;
LayoutKey _LNKK_       = {LN_KAGI_KAKKO,    &Chara1};     LayoutKey* LNKK    = &_LNKK_;
LayoutKey _RNKK_       = {RN_KAGI_KAKKO,    &Chara1};     LayoutKey* RNKK    = &_RNKK_;
LayoutKey _LDBBRK_     = {L_DBL_BRACKET,    &Chara1};     LayoutKey* LDBBRK  = &_LDBBRK_;
