...
void initializeMacros() {
  ...
  ADD_ALTCODE(KEY_DELTA,      KEYPAD_PLUS, KEYPAD_0, KEYPAD_3, KEY_B, KEYPAD_4);
  ...
  ADD_ALTCODE(KEY_SIGMA,      KEYPAD_PLUS, KEYPAD_0, KEYPAD_3, KEY_C, KEYPAD_3);
  ...
  ADD_ALTCODE(RN_KAGI_KAKKO,  KEYPAD_PLUS, KEYPAD_3, KEYPAD_0, KEYPAD_0, KEY_E);
  ADD_ALTCODE(LN_KAGI_KAKKO,  KEYPAD_PLUS, KEYPAD_3, KEYPAD_0, KEYPAD_0, KEY_F);
  ...
  //ADD_ALTCODE(,    KEYPAD_PLUS, KEYPAD_, KEYPAD_, KEYPAD_, KEYPAD_);
